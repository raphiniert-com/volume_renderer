...
/*! \namespace mvr
 *  \brief namespace for matlab volume render
 */
namespace mvr
{
 ...
 * 	\brief The struct contains all rendering options for the raycasting on the device
 */
struct RenderOptions
{
    ...
    float4x3 rotation_matrix; // last vector: [camera x-offset; focal length; object distance]
...
RenderOptions  initRender(	const uint aWidth, const uint aHeight, 
...
void initCuda(const Volume& aVolumeEmission,
